...
data class AggregateFuncs(
        val average: String = "mean",
        val max: String = "max",
        val min: String = "min"
)

data class VirtualSensorValues(
        val virusrisk: List<String> = listOf("transmissionrisk", "staleair", "transmissionefficiency", "survivalrate"),
        val occupancy: List<String> = listOf("ventilationrate", "occupants", "occupantslower", "occupantsupper", "ach", "presence")
)

data class Sensors(
        val sensors: List<String> = listOf("radon", "temp", "co2", "pm25", "voc", "humidity", "light", "virusrisk", "occupancy")
)

data class SensorThresholds(
        val radon: List<Int> = listOf(100, 150),
        val temp: List<Int> = listOf(18, 25),
        val co2: List<Int> = listOf(800, 1000),
        val pm25: List<Int> = listOf(10, 25),
        val voc: List<Int> = listOf(250, 2000),
        val humidity: List<Int> = listOf(25, 30, 60, 70),
        val virusrisk: List<Int> = listOf(1, 4, 7, 10),
        val occupancy: OccupancyThresholds = OccupancyThresholds()
)

data class OccupancyThresholds(
        val ventilationrate: List<Int> = listOf(0, 3, 5, 10, 15, 30),
        val occupants: List<Int> = listOf(0, 5, 10, 15, 20, 25, 50, 100, 500),
        val occupantslower: List<Int> = listOf(0, 5, 10, 15, 20, 25, 50, 100, 500),
        val occupantsupper: List<Int> = listOf(0, 5, 10, 15, 20, 25, 50, 100, 500),
        val ach: List<Int> = listOf(0, 3, 5, 10, 15, 30),
        val presence: List<Int> = listOf(0, 5, 15, 30, 45, 60)
)

data class SensorUnits(
        val radon: String = "Bq/m³",
        val temp: String = "C",
        val co2: String = "ppm",
        val pm25: String = "µg/m³",
        val voc: String = "ppb",
        val humidity: String = "%",
        val virusrisk: String = "score",
        val occupancy: OccupancyUnits = OccupancyUnits()
)

data class OccupancyUnits(
        val ventilationrate: String = "m³/h",
        val occupants: String = "occupants",
        val occupantslower: String = "occupants",
        val occupantsupper: String = "occupants",
        val ach: String = "ACH",
        val presence: String = "minutes"
)
